...
7.如果想暂停shadowsocks，运行sudo /etc/init.d/shadowsocks stop
8.重新启动就运行sudo /etc/init.d/shadowsocks start
9.shadowsocks要依赖chinadns，服务脚本:/etc/init.d/chinadns，不要轻易关闭
